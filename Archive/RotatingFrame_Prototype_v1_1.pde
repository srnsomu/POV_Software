/* Team XGearhead (still need a name) Rotating Frame MAX32 code. 
   ...
   Same as RotatingFrame_v1_3, but with a different initial state: the columns of LEDs 
   alternate in color from red to green to orange/yellow rather than nothing. 
