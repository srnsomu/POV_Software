/* Team XGearhead (still need a name) Rotating Frame MAX32 code. 
   Author: Alex Shie  Latest Revision: 4/11/13
...
#define CURSOR_DELAY 500 //How many ms before toggling the cursor after no input
...
void setup()
{
  ...
  attachInterrupt(2, doEncoder, CHANGE);  // encoder pin on interrupt 2 - pin 7
...
void loop()
{
  ...
  /* Remember: all red and green MOSFETs (except red 3,5 and green 1,2,5) use PORTF, the rest use PORTG. */
